    ...
    <div className="flex-shrink-0 px-4 md:px-6 pb-4 pt-2">
      ...
      <div className="rounded-2xl bg-[#161e2e] border border-[#2a3a50] px-3 py-2.5 flex items-end gap-2 focus-within:border-[#3a4a60] transition-colors">
        ...
        <textarea
          ...
          rows={1}
          disabled={disabled}
          className="flex-1 bg-transparent resize-none text-[#e8eaf0] placeholder-[#4b5563] italic text-sm outline-none py-0.5 leading-relaxed min-h-[22px] max-h-[120px] disabled:opacity-50"
        />
